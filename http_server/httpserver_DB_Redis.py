...
class MyHTTPRequestHandler(BaseHTTPRequestHandler):
        ...
        try:
            ...
            if self.redis and cache_key:
                try:
                    ...
                    logger.warning(f"Failed to cache GET /users: {e}")
    ...
    def handle_POST_user(self):
        ...
        try:
            ...
            # Write-through to Redis and invalidate list caches
            if self.redis:
                try:
    ...
    def handle_PATCH_user(self):
        ...
        try:
            ...
            # Update Redis and invalidate list caches
            if self.redis:
                try:
    ...
    def handle_DELETE_user(self):
        ...
        try:
            ...
            # Remove from Redis and invalidate list caches
            if self.redis:
                try:
                    self.redis.delete(f"user:{user_id}")
                    self._invalidate_users_list_cache()
                except Exception as e:
                    logger.warning(f"Failed to delete key from Redis on DELETE: {e}")
